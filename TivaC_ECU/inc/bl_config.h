...
#define EEPROM_UPDATE_REQUEST_ADDRESS							(0x00U)
#define EEPROM_CURRENT_APP_START_ADDRESS					(0x04U)
#define EEPROM_AVAILABLE_APP_SECTION_ADDRESS			(0x08U)	

#define FIRST_APP_SECTION_ADDRESS									 (0x08000)
#define SECOND_APP_SECTION_ADDRESS								 (0x0C000)
