...
void Rte_Read_NewUpdateRequest( boolean* var ) ;                         // GUI Interface SWC
...
void Rte_Read_NewEncryptedDataFlg( boolean* var ) ;            // Decryption SWC
...
Std_ReturnType Rte_Write_UpdateRequestAccepted( boolean val ) ;         // GUI Interface SWC
void Rte_Read_UpdateRequestAccepted( boolean* var ) ;                   // download update SWC
...
void Rte_Read_DoneDownloading( boolean* var ) ;                          // Distribution SWC
